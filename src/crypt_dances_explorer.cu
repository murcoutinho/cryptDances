...
void example_differential_correlation_chaskey2()
{
    differential_t diff = {
            ALG_TYPE_CHASKEY,
            {{0}, {0},{31},3, 1}, //id
...
void example_differential_correlation_chaskey3()
{
    differential_t diff = {
            ALG_TYPE_CHASKEY,
            {{0}, {0},{31},3, 1}, //id
...
void example_differential_correlation_chaskey4()
{
    differential_t diff = {
            ALG_TYPE_CHASKEY,
            {{0}, {0},{15},3, 1}, //id
...
void example_differential_correlation_chaskey5()
{
    differential_t diff = {
            ALG_TYPE_CHASKEY,
...
int main()
{
    ...
    example_differential_correlation_chaskey2();
    ...
    number_of_trials<<=28;
     while(1){
     compute_all_single_bit_differential_correlation(ALG_TYPE_CHASKEY, 9, 2, 
         number_of_trials, "all_single_bit_differentials_from_2_to_11_subrounds_of_chaskey.dat",-1,-1);
    }
